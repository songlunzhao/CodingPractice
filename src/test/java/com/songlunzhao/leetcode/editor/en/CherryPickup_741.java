...
//
// 
// Starting at the position (0, 0) and reaching (n - 1, n - 1) by moving right o
//r down through valid path cells (cells with value 0 or 1). 
// After reaching (n - 1, n - 1), returning to (0, 0) by moving left or up throu
//gh valid path cells. 
...
public class CherryPickup_741 {
    ...
    public void testCherryPickup(){
       Solution solution = new CherryPickup_741()
                        .new Solution();
    }
