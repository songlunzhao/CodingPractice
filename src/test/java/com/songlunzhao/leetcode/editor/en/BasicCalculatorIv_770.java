...
//tion, then addition and subtraction. 
//
// 
...
//
// 
// For each term of free variables with a non-zero coefficient, we write the fre
//e variables within a term in sorted order lexicographically.
// 
// For example, we would never write a term like "b*a*c", only "a*b*c". 
// 
// 
// Terms have degrees equal to the number of free variables being multiplied, co
//unting multiplicity. We write the largest degree terms of our answer first, brea
//king ties by lexicographic order ignoring the leading coefficient of the term.
// 
...
//
// 
//Input: expression = "e - 8 + temperature - pressure", evalvars = ["e", "temper
//ature"], evalints = [1, 12]
//Output: ["-1*pressure","5"]
// 
//
...
public class BasicCalculatorIv_770 {
    ...
    @Test
    public void testBasicCalculatorIv(){
       Solution solution = new BasicCalculatorIv_770()
                        .new Solution();
    }
