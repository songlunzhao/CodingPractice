//You are given an n x n integer matrix grid where each value grid[i][j] represe
//nts the elevation at that point (i, j). 
//
// The rain starts to fall. At time t, the depth of the water everywhere is t. Y
...
//ite distances in zero time. Of course, you must stay within the boundaries of th
//e grid during your swim. 
//
...
public class SwimInRisingWater_778 {
    ...
    public void testSwimInRisingWater(){
       Solution solution = new SwimInRisingWater_778()
                        .new Solution();
    }
