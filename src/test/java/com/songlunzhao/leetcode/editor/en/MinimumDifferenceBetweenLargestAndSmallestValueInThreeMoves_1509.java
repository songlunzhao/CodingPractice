...
public class MinimumDifferenceBetweenLargestAndSmallestValueInThreeMoves_1509 {
    ...
    @Test
    public void testMinimumDifferenceBetweenLargestAndSmallestValueInThreeMoves(){
       Solution solution = new MinimumDifferenceBetweenLargestAndSmallestValueInThreeMoves_1509()
                        .new Solution();
    }
