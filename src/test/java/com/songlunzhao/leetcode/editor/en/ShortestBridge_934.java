//In a given 2D binary array grid, there are two islands. (An island is a 4-dire
//ctionally connected group of 1s not connected to any other 1s.) 
//
...
public class ShortestBridge_934 {
    ...
    public void testShortestBridge(){
       Solution solution = new ShortestBridge_934()
                        .new Solution();
    }
