...
//
// Note that for an array arr, average(arr) is the sum of all the elements of ar
//r over the length of arr. 
//
// 
// Example 1: 
//
...
public class SplitArrayWithSameAverage_805 {
    ...
    @Test
    public void testSplitArrayWithSameAverage(){
       Solution solution = new SplitArrayWithSameAverage_805()
                        .new Solution();
    }
