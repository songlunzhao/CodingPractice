//You are given two images img1 and img2 both of size n x n, represented as bina
//ry, square matrices of the same size. (A binary matrix has only 0s and 1s as val
//ues.) 
//
...
public class ImageOverlap_835 {
    ...
    @Test
    public void testImageOverlap(){
       Solution solution = new ImageOverlap_835()
                        .new Solution();
    }
