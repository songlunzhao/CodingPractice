...
//where the first element accounts[i][0] is a name, and the rest of the elements a
...
//
// 
//Input: accounts = [["John","johnsmith@mail.com","john_newyork@mail.com"],["Joh
//n","johnsmith@mail.com","john00@mail.com"],["Mary","mary@mail.com"],["John","joh
//nnybravo@mail.com"]]
...
//
// 
//Input: accounts = [["Gabe","Gabe0@m.co","Gabe3@m.co","Gabe1@m.co"],["Kevin","K
//evin3@m.co","Kevin5@m.co","Kevin0@m.co"],["Ethan","Ethan5@m.co","Ethan4@m.co","E
//than0@m.co"],["Hanzo","Hanzo3@m.co","Hanzo1@m.co","Hanzo0@m.co"],["Fern","Fern5@
...
//"],["Kevin","Kevin0@m.co","Kevin3@m.co","Kevin5@m.co"],["Fern","Fern0@m.co","Fer
//n1@m.co","Fern5@m.co"]]
// 
//
// 
...
// 
// Related Topics Array String Depth-First Search Breadth-First Search Union Fin
//d 
// 👍 2767 👎 484
...
public class AccountsMerge_721 {
    ...
    public void testAccountsMerge(){
       Solution solution = new AccountsMerge_721()
                        .new Solution();
    }
